...
This repository contains scripts and notes for running Cellpose-based segmentation and, later on, cell tracking and analysis for single-cell HEK293T (transfected with VPC construct and stimulated with pro-inflammatory cytokine IL-1β) imaging experiments.
---
